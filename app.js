        ...
        (position =>{
            ...
            fetch(apiWeather)
                ...
                .then(response =>{
                    ...
                    const {Temperature:{Maximum,Minimum}, Day:{IconPhrase}} = response.DailyForecasts[0];
                    const {Headline:{Text}} = response;
                    ...
                    // Set the SVG Icon's based on the API's Icon Phrase Value
                    
                    if(IconPhrase === 'Sunny'){
                        icon.innerHTML = `<svg class="sunshine" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                    ...
                    }else if(IconPhrase === 'Cloudy'){
                       icon.innerHTML = `<svg class="windy-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                       <g class="cloud-wrap">
                       ...
                       <path class="wind-one" d="M16,256h64c8.8,0,16-7.2,16-16s-7.2-16-16-16H16c-8.8,0-16,7.2-16,16S7.2,256,16,256z" />
                    ...
                    }else if (IconPhrase === 'T-Storms'){
                        icon.innerHTML = `<svg class="thunder-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                        ...
                        icon.innerHTML = ` <svg class="rain-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                    ...
                    `
                    }else if (IconPhrase === 'Snow'){
                        icon.innerHTML = `<svg class="snow-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                        ...
                        c4.1-4.1,10.8-4.1,14.9,0C442.4,392.2,442.4,398.9,438.3,402.9z" />
                         ...
                         icon.innerHTML = `<svg class="sun-cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
